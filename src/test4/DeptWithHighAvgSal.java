...
public class DeptWithHighAvgSal {
    public static void main(String[] args) {
        ...
        Map<String, Double> collect = employees
                .stream()
                .collect(Collectors.
                        groupingBy(EmployeeNew::getDept,
                                Collectors.averagingDouble(EmployeeNew::getSalary)));
        Optional<Map.Entry<String, Double>> max = collect.entrySet().stream()
